...
def plot_bloch_comparison(states, labels, title="Qubit State Comparison", figsize=(15, 5)):
...
def plot_probability_evolution(states_over_time, labels=None, title="Quantum State Evolution"):
...
def plot_quantum_circuit_with_explanation(circuit, explanation_text, figsize=(14, 8)):
    ...
    ax_text.text(0.05, 0.5, explanation_text, transform=ax_text.transAxes, 
                fontsize=11, verticalalignment='center', wrap=True,
...
def plot_quantum_vs_classical(quantum_data, classical_data, 
                            metric_name="Value", title="Quantum vs Classical Comparison"):
...
def create_educational_animation_frames(states, frame_labels, save_prefix="animation_frame"):
...
def plot_algorithm_complexity(problem_sizes, quantum_times, classical_times, 
                            algorithm_name="Algorithm", log_scale=True):
    ...
    ax.plot(problem_sizes, quantum_times, 'b-o', label='Quantum', linewidth=3, markersize=8)
    ax.plot(problem_sizes, classical_times, 'r-s', label='Classical', linewidth=3, markersize=8)
...
if __name__ == "__main__":
    ...
    save_figure_with_metadata(fig, "test_visualization.png", 

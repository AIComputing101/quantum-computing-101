...
def interactive_debugging_demo():
    ...
    qc_statevector.remove_final_measurements(inplace=False)  # Remove measurements for statevector
...
def main():
    ...
    parser.add_argument('--interactive', action='store_true',
                       help='Run interactive debugging demos')
    parser.add_argument('--skip-noise', action='store_true',
                       help='Skip noise model demonstrations')

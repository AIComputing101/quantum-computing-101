...
def compare_quantum_classical_randomness():
    ...
    axes[2].hist(classical_numbers_2, bins=20, alpha=0.7, color='green', edgecolor='black')
...
def main():
    ...
    try:
        ...
        print("• module1_05_randomness_comparison.png - Quantum vs classical comparison")
